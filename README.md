...
* When/If the SFOS upgrade fails see [this](https://jolla.zendesk.com/hc/en-us/articles/360005795474) for help. Doing the cleanups, setting the release back to the current version and running `pkcon refresh`, `pkccon update` & `reboot` is worth trying. 
